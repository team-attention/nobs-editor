...
export function App() {
  ...
  const { hasConflict, acceptExternal, dismissConflict } = useFileWatcher({ currentFilePath, isDirty, loadFile });
  ...
  return (
    <div id="app">
      ...
      {hasConflict && (
        <ConflictBanner onReload={acceptExternal} onKeep={dismissConflict} />
      )}
